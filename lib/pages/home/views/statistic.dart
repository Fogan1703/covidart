                          ...
                          return AnimatedBuilder(
                            ...
                            builder: (context, child) {
                              final tween = index == 0
                                  ...
                                  : Tween<double>(begin: 1, end: 0.6);

                              return FadeTransition(
                                opacity: tween.animate(_totalController),
                                child: child,
                              );
                            },
                  ...
                  return TabBarView(
                    children: [
                      state.countryStatistic != null
                          ? _buildStatistic(state.countryStatistic!, _isTotal)
                          : _buildNoCountryView(),
                      _buildStatistic(state.worldStatistic, _isTotal),
                    ],
                  );
                },
              ),
